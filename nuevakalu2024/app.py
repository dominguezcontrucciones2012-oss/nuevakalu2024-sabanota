...
from models import db, TasaBCV, Producto, Proveedor, MovimientoProductor, ahora_ve, hoy_ve, User
...
app = Flask(__name__)
CORS(app, resources={r"/api/*": {"origins": "*"}}) # Allow React app to connect to API routes
...
# Optimizaciones de alta concurrencia para SQLite
