...
with app.app_context():
    ...
    for pid in [10, 7]:
        ...
        output.append(f"\n==========================================")
        output.append(f"ORDEN DE INSERCION (ID) DE: {p.nombre} (ID: {p.id})")
        output.append(f"==========================================")
    ...
    with open('scratch/id_order_results.txt', 'w', encoding='utf-8') as f:
        f.write('\n'.join(output))
    print("Listado completo guardado en scratch/id_order_results.txt")
